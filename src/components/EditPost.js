...
import { Row, Col, Image, Button, Form, Card, FloatingLabel } from 'react-bootstrap';
import * as Yup from 'yup';
import { useForm } from 'react-hook-form';
import { yupResolver } from '@hookform/resolvers/yup';

// export default function EditPost ({ loggedInUser, author, setRenderNewPost })  {
export default function EditPost ({ loggedInUser, author })  {
        ...
        <Form onSubmit={handleSubmit(submitHandler)}>
              ...
              {/* <Row >
                <div style={{display: 'flex', justifyContent: 'flex-end'}}>
                  <Button className="pl-5" variant="primary" type="submit" style={{padding: '0.6rem 1rem'}}>Create Post</Button>
                </div>
              </Row> */}
        </Form>
      </div>
